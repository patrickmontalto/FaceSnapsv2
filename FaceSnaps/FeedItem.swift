...
final class FeedItem: Object, IGListDiffable {
    ...
    convenience init(pk: Int, user: User, caption: String, comments: List<Comment>, photoURLString: String, liked: Bool, datePosted: Date, likesCount: Int, location: Location?) {
        self.init()
